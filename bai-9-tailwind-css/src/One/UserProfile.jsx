function UserProfile() {
  return (
    <>
      <div className="flex w-[36rem] gap-1 gap-x-4 rounded-lg bg-white p-12">
        <img
        ...
        <div className="space-y-7">
          <div>
            ...
            <h2 className="mt-1">ReactJS TailwindCSS</h2>
          </div>
          ...
          <button className="rounded-md border-2 border-[#ccc] p-2">
            Show more
          </button>
        </div>
      </div>
